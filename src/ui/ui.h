...
BETTER_ENUM(SystemMenuType, int, None, RNE, MO6TW, CHLCC)
BETTER_ENUM(SaveMenuType, int, None, MO6TW, CHLCC, CCLCC)
BETTER_ENUM(SysMesBoxType, int, None, RNE, Dash, CHLCC, MO6TW, Darling, CC, SG)
BETTER_ENUM(TitleMenuType, int, None, RNE, Dash, CHLCC, MO6TW, CC, CCLCC, SG)
BETTER_ENUM(OptionsMenuType, int, None, MO6TW, CCLCC)
BETTER_ENUM(TipsMenuType, int, None, MO6TW, CCLCC)
